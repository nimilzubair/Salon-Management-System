...
cout << "MAKEUP ARTISTS\t\tFEES\t\t\tOFF DAY" << endl << endl;
for (int i = 0; i < 8; i++) {
...
cout << endl;
cout << "MENI PEDI & FACIAL\tFEES\t\t\tOFF DAY" << endl << endl;
for (int i = 0; i < 5; i++) {
cout << staff_facial_meni_pedi[i] << "\t\t\t";
cout << "Rs." << price_facial_meni_pedi[i] << "\t\t\t";
...
int main() {
system("color fc");
cout << endl << endl << endl << endl << endl << "----------------------------------------------- WELCOME TO WAN SALON -----------------------------------------------" << endl << endl << endl << endl;
system("pause");
system("cls");
system("color fc");
